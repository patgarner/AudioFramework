...
#import "PassThroughNodeAudioUnit.h"
...
@interface PassThroughNodeAudioUnit ()
...
@implementation PassThroughNodeAudioUnit
...
- (AUAudioUnitBusArray *)inputBusses {
    ...
    AUAudioUnitBus * bus = [[AUAudioUnitBus alloc] init];
    NSArray * array = [NSArray arrayWithObjects: bus];
    return array;
}
